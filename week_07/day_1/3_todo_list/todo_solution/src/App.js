  ...
  return (
    <>
      ...
      <form onSubmit={saveNewTodo} >
        ...
        <input id="high" type="radio" name="prioritySelect" value="high" onChange={handlePrioritySelect} />
        <label htmlFor="low">Low</label>
        <input id="low" type="radio" name="prioritySelect" value="low" onChange={handlePrioritySelect}/> 
